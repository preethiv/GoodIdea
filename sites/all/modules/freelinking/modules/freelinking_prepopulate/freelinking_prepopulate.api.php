<?php
// $Id: freelinking_prepopulate.api.php,v 1.1.2.2 2010/04/01 17:56:04 grayside Exp $
/**
...
function freelinking_prepopulate_list_fields($plugin = 'nodecreate', $field = NULL) {
  ...
  if (!$fields) {
    if (module_exists('taxonomy')) {
      $fields['taxonomy'] = array('title' => t('Same taxonomy terms (for shared vocabularies)'),
        'prepopulate' => 'edit[taxonomy][tags]');
      $plugins['nodecreate']['taxonomy'] = TRUE;
    }
    if (module_exists('book')) {
      $fields['book'] = array('title' => t('Parent book page'),
        'prepopulate' => 'parent');
